...
hps_ms = utils.get_hparams_from_file(r'/Users/tudou/Downloads/声音模型/vits模型20230120/config.json')
...
model, optimizer, learning_rate, epochs = utils.load_checkpoint(r'/Users/tudou/Downloads/声音模型/vits模型20230120/G_953000.pth', net_g_ms, None)
